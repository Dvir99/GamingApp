...
export class RegisterComponent implements OnInit{
  ...
  initForm(){
    this.registerForm = this.fb.group({
      ...
      knownAs: ['',[Validators.maxLength(20),Validators.required]],
      dateOfBirth: ['',[Validators.maxLength(20),Validators.required]],
  ...
  register(){
    ...
    this.accountService.register(values).subscribe({
      next: () => {
        this.toastr.success(`Register Success, ${this.registerForm.controls['username'].value}`)
